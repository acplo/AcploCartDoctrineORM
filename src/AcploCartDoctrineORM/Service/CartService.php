...
namespace AcploCartDoctrineORM\Service;

use Doctrine\Common\Persistence\ObjectManager;
use AcploCartDoctrineORM\Entity\CartEntityInterface as CartInterface;
use AcploCartDoctrineORM\Entity\CartItemInterface;
use AcploCartDoctrineORM\Hydrator\CartItemHydrator;

class CartService implements CartServiceInterface
{
    protected $objectManager;
    protected $cartEntityClass = 'AcploCartDoctrineORM\Entity\Cart';
    protected $hydrator;
    protected $cartItemClass = 'AcploCartDoctrineORM\Entity\CartItem';
    ...
    /**
     * retrive AcploCart array from db
     * @return [type] [description]
     */
    public function restoreAcploCartArray($cartId)
    {
        //extract cart items
        $zfProducts = array();
